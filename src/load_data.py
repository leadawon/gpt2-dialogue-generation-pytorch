...
def merge_data(tokenizer, args):
    ...
    for data_name in dataset_list:
        ...
        elif data_name == 'custom_dialog':
            part_train_dialogues, part_valid_dialogues, part_num_train, part_num_valid = load_custom(tokenizer, args.train_frac)
